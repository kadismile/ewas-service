...
import { EditIncidentTypeModal } from "../modals/EditIncidentTypeModal";
import { AddReportTypeModal } from "../modals/AddReportTypeModal";

export const IncidentTypes = (props) => {
  ...
  const fetchData = () => {
    reportService.getReportTypes().then((res) => {
      const { data } = res;
      setdata(data);
  ...
  const deleteBundle = (data) => {
    let onOk = async () => {
      const response = await reportService.delReportTypes(data);
  ...
  return (
    <>
      <EditIncidentTypeModal show={showModal} onHide={handleCloseModal} data={editData} />
      <AddReportTypeModal show={showAddModal} onHide={handleCloseModal} />
        ...
        <div className="box-content">
          <div className="box-heading">
            <div className="box-title">
              <h3 className="mb-35">Incident Types Management</h3>
            </div>
