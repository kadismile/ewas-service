              ...
              <div className="banner-inner">
                <div className="row">
                  <div className="col-xl-7 col-lg-12">
                    ...
                    <h2 className="heading-banner wow animate__animated animate__fadeInUp">Institute for Peace and Conflict Resolution
                      &nbsp;
                     </h2>
                     <h1 className='heading-banner wow animate__animated animate__fadeInUp'> <span style={{ color:'#d01f2d', fontSize: '27px'}}>Conflict Early Warning Early Response System</span></h1>
