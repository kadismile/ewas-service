  ...
  const validateForm = (name, errors, value) => {
    switch (name) {
      ...
      case "repeatPassword":
        ...
        if (value.length && value.length <= 3) {
          errors.repeatPassword =
            "repeated password must be more than 3 characters long!";
          setSubmitForm(false);
        } else if (value !== formValues.password) {
          errors.repeatPassword =
            "repeated password must be same with password!";
          setSubmitForm(false);
        } else {
          setSubmitForm(true);
        }
      ...
      case "phoneNumber":
        ...
        if (value.length > 1 && value.length <= 10) {
          errors.phoneNumber =
            "phoneNumber must be more than 11 characters long!";
          setSubmitForm(true);
        } else {
          setSubmitForm(false);
        }
            ...
            <div className="col-lg-6 col-md-6 col-sm-12 mx-auto">
              ...
              <form className="login-register text-start mt-20" action="#">
                ...
                <div className="form-group">
                  ...
                  <Places />
                  {errors.address ? (
                    <span className={styles.form_error}> {errors.address}</span>
                  ) : (
                    ""
                  )}
                </div>
