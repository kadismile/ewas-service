                ...
                <form className="login-register text-start mt-20" action="#">
                  <div className="form-group">
                    ...
                    <input className="form-control" 
                      ...
                      required
                    />
                    { errors.fullName ? <span className={styles.form_error}> {errors.fullName}</span> : ''}
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <input 
                      ...
                      required
                    />
                    { errors.phoneNumber ? <span className={styles.form_error}> {errors.phoneNumber}</span> : ""}
                  </div>

                  <div className="form-group">
                    <label className="form-label" htmlFor="input-2">Address *</label>
                    <Places />
                    { errors.address ? <span className={styles.form_error}> {errors.address}</span> : ""}
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <input 
                      ...
                      placeholder="************"
                    />
                    { errors.repeatPassword ? <span className={styles.form_error}> {errors.repeatPassword}</span> : ""}
                  </div>
