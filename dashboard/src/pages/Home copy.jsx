        ...
        <div className="col-xxl-8 col-xl-7 col-lg-7">
          <div className="section-box">
            <div className="row"> 
              ...
              <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                <div className="card-style-1 hover-up">
                  <div className="card-image"> <img src="/images/open-file.svg" alt="jobBox" /></div>
                  <div className="card-info"> 
                    <div className="card-title">
              ...
              <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                <div className="card-style-1 hover-up">
                  <div className="card-image"> <img src="/images/man.svg" alt="jobBox" /></div>
                  <div className="card-info"> 
                    <div className="card-title">
            ...
            <div className="container"> 
              <div className="panel-white">
                <div className="panel-head"> 
                  <h5>Vacancy Stats</h5><a className="menudrop" id="dropdownMenu2" type="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-display="static" />
                ...
                <div className="panel-body">
                  <div className="card-style-2 hover-up">
                    <div className="card-head">
                      <div className="card-image"> <img src="/images/img1.png" alt="jobBox" /></div>
                      <div className="card-title"> 
                  ...
                  <div className="card-style-2 hover-up">
                    <div className="card-head">
                      <div className="card-image"> <img src="/images/img2.png" alt="jobBox" /></div>
                      <div className="card-title"> 
                        <h6>Senior Full Stack Engineer, Creator Success</h6><span className="job-type">Full time</span><span className="time-post">3mins ago</span><span className="location">Chicago, US</span>
                      </div>
                    </div>
                  ...
                  <div className="card-style-2 hover-up">
                    <div className="card-head">
                      <div className="card-image"> <img src="/images/img3.png" alt="jobBox" /></div>
                      <div className="card-title"> 
                        <h6>Lead Product/UX/UI Designer Role</h6><span className="job-type">Full time</span><span className="time-post">3mins ago</span><span className="location">Paris, France</span>
                      </div>
                    </div>
                    <div className="card-tags"> <a className="btn btn-tag">Figma</a><a className="btn btn-tag">Adobe XD</a><a className="btn btn-tag">PSD</a>
                    </div>
                  ...
                  <div className="card-style-2 hover-up">
                    <div className="card-head">
                      <div className="card-image"> <img src="/images/img4.png" alt="jobBox" /></div>
                      <div className="card-title"> 
                        <h6>Marketing Graphic Designer</h6><span className="job-type">Full time</span><span className="time-post">3mins ago</span><span className="location">Tokyto, Japan</span>
                      </div>
                    </div>
                    <div className="card-tags"> <a className="btn btn-tag">Figma</a><a className="btn btn-tag">Adobe XD</a><a className="btn btn-tag">PSD</a>
                    </div>
                  ...
                  <div className="card-style-2 hover-up">
                    <div className="card-head">
                      <div className="card-image"> <img src="/images/img5.png" alt="jobBox" /></div>
                      <div className="card-title"> 
                        <h6>Director, Product Design - Creator</h6><span className="job-type">Full time</span><span className="time-post">3mins ago</span><span className="location">Ha Noi, Vietnam</span>
                      </div>
                    </div>
                    <div className="card-tags"> <a className="btn btn-tag">Figma</a><a className="btn btn-tag">Adobe XD</a><a className="btn btn-tag">PSD</a>
                    </div>
        ...
        <div className="col-xxl-4 col-xl-5 col-lg-5">
          <div className="section-box">
            <div className="container"> 
              <div className="panel-white">
                <div className="panel-head"> 
                  <h5>Top Candidates</h5><a className="menudrop" id="dropdownMenu4" type="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-display="static" />
          ...
          <div className="section-box">
            <div className="container"> 
              <div className="panel-white">
                <div className="panel-head"> 
                  <h5>Top Recruiters</h5><a className="menudrop" id="dropdownMenu5" type="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-display="static" />
                    ...
                    <div className="col-lg-6 col-md-6 pr-5 pl-5">
                      <div className="card-style-4 hover-up">
                        <div className="d-flex">
                          <div className="card-image"><img src="/images/avata1.png" alt="jobBox" /></div>
                          <div className="card-title"> 
                            <h6>Robert Fox</h6><img src="/images/star.svg" alt="jobBox" /> <img src="/images/star.svg" alt="jobBox" /> <img src="/images/star.svg" alt="jobBox" /> <img src="/images/star-none.svg" alt="jobBox" /> <img src="/images/star-none.svg" alt="jobBox" /> <span className="font-xs color-text-mutted">
                              (65)</span>
                          </div>
                        </div>
                        <div className="card-location d-flex"><span className="location">Red, CA</span><span className="jobs-number">25 Open Jobs</span></div>
                      </div>
                    </div>
                    <div className="col-lg-6 col-md-6 pr-5 pl-5">
                      <div className="card-style-4 hover-up">
                        <div className="d-flex">
                          <div className="card-image"><img src="/images/avata2.png" alt="jobBox" /></div>
                          <div className="card-title"> 
                            <h6>Cody Fisher</h6><img src="/images/star.svg" alt="jobBox" /> <img src="/images/star.svg" alt="jobBox" /> <img src="/images/star.svg" alt="jobBox" /> <img src="/images/star-none.svg" alt="jobBox" /> <img src="/images/star-none.svg" alt="jobBox" /> <span className="font-xs color-text-mutted">
                              (65)</span>
                          </div>
                        </div>
                        <div className="card-location d-flex"><span className="location">Chicago, US</span><span className="jobs-number">25 Open Jobs</span></div>
                      </div>
                    </div>
                    <div className="col-lg-6 col-md-6 pr-5 pl-5">
                      <div className="card-style-4 hover-up">
                        <div className="d-flex">
                          <div className="card-image"><img src="/images/avata3.png" alt="jobBox" /></div>
                          <div className="card-title"> 
                            <h6>Jane Cooper</h6><img src="/images/star.svg" alt="jobBox" /> <img src="/images/star.svg" alt="jobBox" /> <img src="/images/star.svg" alt="jobBox" /> <img src="/images/star-none.svg" alt="jobBox" /> <img src="/images/star-none.svg" alt="jobBox" /> <span className="font-xs color-text-mutted">
                              (65)</span>
                          </div>
                        </div>
                        <div className="card-location d-flex"><span className="location">Austin, TX</span><span className="jobs-number">25 Open Jobs</span></div>
                      </div>
                    </div>
                    <div className="col-lg-6 col-md-6 pr-5 pl-5">
                      <div className="card-style-4 hover-up">
                        <div className="d-flex">
                          <div className="card-image"><img src="/images/avata4.png" alt="jobBox" /></div>
                          <div className="card-title"> 
                            <h6>Jerome Bell</h6><img src="/images/star.svg" alt="jobBox" /> <img src="/images/star.svg" alt="jobBox" /> <img src="/images/star.svg" alt="jobBox" /> <img src="/images/star-none.svg" alt="jobBox" /> <img src="/images/star-none.svg" alt="jobBox" /> <span className="font-xs color-text-mutted">
                              (65)</span>
                          </div>
                        </div>
                        <div className="card-location d-flex"><span className="location">Remote</span><span className="jobs-number">25 Open Jobs</span></div>
                      </div>
                    </div>
                    <div className="col-lg-6 col-md-6 pr-5 pl-5">
                      <div className="card-style-4 hover-up">
                        <div className="d-flex">
                          <div className="card-image"><img src="/images/avata5.png" alt="jobBox" /></div>
                          <div className="card-title"> 
                            <h6>Floyd Miles</h6><img src="/images/star.svg" alt="jobBox" /> <img src="/images/star.svg" alt="jobBox" /> <img src="/images/star.svg" alt="jobBox" /> <img src="/images/star-none.svg" alt="jobBox" /> <img src="/images/star-none.svg" alt="jobBox" /> <span className="font-xs color-text-mutted">
                              (65)</span>
                          </div>
                        </div>
                        <div className="card-location d-flex"><span className="location">Boston, US</span><span className="jobs-number">25 Open Jobs</span></div>
                      </div>
                    </div>
                    <div className="col-lg-6 col-md-6 pr-5 pl-5">
                      <div className="card-style-4 hover-up">
                        <div className="d-flex">
                          <div className="card-image"><img src="/images/avata1.png" alt="jobBox" /></div>
                          <div className="card-title"> 
                            <h6>Devon Lane</h6><img src="/images/star.svg" alt="jobBox" /> <img src="/images/star.svg" alt="jobBox" /> <img src="/images/star.svg" alt="jobBox" /> <img src="/images/star-none.svg" alt="jobBox" /> <img src="/images/star-none.svg" alt="jobBox" /> <span className="font-xs color-text-mutted">
                              (65)</span>
                          </div>
                        </div>
                        <div className="card-location d-flex"><span className="location">Chicago, US</span><span className="jobs-number">25 Open Jobs</span></div>
          ...
          <div className="section-box">
            <div className="container"> 
              <div className="panel-white">
                <div className="panel-head"> 
                  <h5>Queries by search</h5><a className="menudrop" id="dropdownMenu6" type="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-display="static" />
              ...
              <div className="box-swiper">
                <div className="swiper-container swiper-group-10">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide"> <img src="/images/microsoft.svg" alt="jobBox" /></div>
                    <div className="swiper-slide"> <img src="/images/sony.svg" alt="jobBox" /></div>
                    <div className="swiper-slide"> <img src="/images/acer.svg" alt="jobBox" /></div>
                    <div className="swiper-slide"> <img src="/images/nokia.svg" alt="jobBox" /></div>
                    <div className="swiper-slide"> <img src="/images/asus.svg" alt="jobBox" /></div>
                    <div className="swiper-slide"> <img src="/images/casio.svg" alt="jobBox" /></div>
                    <div className="swiper-slide"> <img src="/images/dell.svg" alt="jobBox" /></div>
                    <div className="swiper-slide"> <img src="/images/panasonic.svg" alt="jobBox" /></div>
                    <div className="swiper-slide"> <img src="/images/vaio.svg" alt="jobBox" /></div>
                    <div className="swiper-slide"> <img src="/images/sony.svg" alt="jobBox" /></div>
                  </div>
                </div>
              </div>
